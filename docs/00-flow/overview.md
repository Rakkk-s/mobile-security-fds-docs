...
| --- | --- | --- | --- |
| [보이스피싱](entry-01-voicephishing.md) | 전화 | 발신번호 변조 전화를 받고 사칭에 속아 앱 설치·정보 제공·이체를 직접 수행 | 임정락 |
| [스미싱](entry-02-smishing.md) | 문자 | 문자 내 URL 클릭 → 피싱사이트 입력 또는 APK 설치 | 김주연 |
| [큐싱](entry-03-qshing.md) | QR코드 | QR 스캔(목적지 은닉 상태) → 피싱사이트 또는 APK 설치 | 김현섭 |
...
어떤 흔적을 어떤 조건으로 판정할지는 [FDS 룰 설계](../05-fds-rule/principles.md)에서 다룹니다.
>>>>>>> Stashed changes
